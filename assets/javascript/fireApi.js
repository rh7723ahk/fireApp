function fireApi(inputLocation){
	...
	var queryURL = "https://api.aerisapi.com/fires/within?p=" + inputLocation + "&radius=50mi&limit=10&filter=critical&client_id=38Kg3ZDxs3eiKihJ1pDYW&client_secret=Y2dpsgFp0570JXPe7Aeeam57UYVsIt0dIpa0nIEd";
	...
	method: "GET"
		...
		googleMapApi(userInputLocation);
